      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-black/60 backdrop-blur-xl rounded-2xl border border-emerald-500/30 p-6 md:p-10">
            ...
            {/* Google Form Button */}
            <Link 
              href="https://forms.gle/aX7NvmAHtoPhLqBF8" 
              target="_blank"
              className="block w-full"
            >
              <div className="relative group/btn">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl blur opacity-0 group-hover/btn:opacity-60 transition-opacity duration-300" />
                
                <button
                  className="relative w-full px-8 py-6 rounded-xl font-bold tracking-wider uppercase transition-all duration-300 border-2 bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border-emerald-500 text-emerald-300 hover:bg-emerald-500/30 hover:text-white"
                >

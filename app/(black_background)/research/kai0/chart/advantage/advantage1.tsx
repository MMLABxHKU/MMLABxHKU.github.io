                ...
                <ChartContainer config={chartConfig}>
                    <BarChart accessibilityLayer data={chartData} margin={{ top: 16, right: 0, left: 0, bottom: 0 }}>
                        <defs>
                            ...
                            <filter id="glassGlowAdv1" x="-50%" y="-50%" width="200%" height="200%">

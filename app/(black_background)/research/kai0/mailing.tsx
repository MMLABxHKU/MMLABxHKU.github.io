...
export function EmailSubscribe() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            await fetch('https://855a7d8a.sibforms.com/serve/MUIFAHvMRnDHa-jw4GgbBzFCpeKTBcfAAdQ3_WHz5m5GOJugx2h3srw6PTCk83XziouQJcGG2pJTjzn4OKE0Cv7LIso36yIAoGhqLEpoirjTXqBTLUJZADYRdK4TthSDzVc7sqE4-OzpB2lRvhyVQnlWN6z6TG6IxUH-x8_8TwoB_XseDAtD1XHWvYaTmmZjHg53ufU6HK5VoTa60A==', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] p-8 md:p-10">
                ...
                <div className="relative z-10">
                    ...
                    {!subscribed ? (
                        <div className={cn(
                            ...
                            focused ? "border-white/20 shadow-[0_0_0_3px_rgba(255,255,255,0.05)]" : "border-white/[0.08]"
                        )}>
                            {/* Email icon */}
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent border-none outline-none px-3 py-4 text-sm text-white placeholder:text-neutral-500"
                            />
                            ...
                            <button
                                ...
                                className={cn(
                                    "mr-2 px-5 py-2.5 rounded-lg text-sm font-medium transition-all duration-300",
                        ...
                        <div className="flex items-center justify-center gap-3 py-4 text-sm">
                            ...
                            <span className="text-neutral-300">You're on the list. We'll be in touch.</span>
                        </div>
                    )}

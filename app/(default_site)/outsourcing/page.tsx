...
{/* 测试组件引用 开始 */}
import LineVideo from "@/app/(default_site)/(blog)/FoldAnything/(element)/interactive/lineVideo"
import TextTip from "@/app/(default_site)/(blog)/FoldAnything/(element)/quotation/textTip"
    ...
    return (
        <main>
            ...
            <div className="w-full max-w-7xl pl-6 pr-6" style={{margin:'50px auto 0 auto'}}>
                <LineVideo data={results} height="500px" />
            </div>

            <div className="w-full max-w-7xl pl-6 pr-6" style={{margin:'50px auto 0 auto'}}>
                <TextTip html={data.data.html} tipList={data.data.tipList} />
            </div>

            <div className="w-full max-w-7xl pl-6 pr-6" style={{margin:'50px auto 0 auto'}}>
                <SwiperVideo data={[
                    'https://test2.h5.org.cn/20251217/value_folding_3.mp4',
                    'https://test2.h5.org.cn/20251217/value_folding_3.mp4',
                    'https://test2.h5.org.cn/20251217/value_folding_3.mp4',
                    'https://test2.h5.org.cn/20251217/value_folding_3.mp4',
                    'https://test2.h5.org.cn/20251217/value_folding_3.mp4',
